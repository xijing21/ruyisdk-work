...
| 阿里巴巴平头哥        | 玄铁系列IP，AIoT/高性能计算                                       | https://www.xrvm.cn/      |     | 玄铁C906/C910/C930等，生态成熟；玄铁C930服务器级已交付，RISE唯一中国董事会成员                  |
...
| 晶芯科技              | 台湾新兴的RISC-V CPU IP供应商，致力于提供高性能和可配置的解决方案 | https://hzt.com.tw/        | -                           |                                                                                                 |
...
| DARE项目（欧洲EuroHPC）            | EuroHPC联合体启动，开发多款数据中心级RISC-V芯片；2.4亿欧元HPC/AI RISC-V处理器开发 | https://eurohpc-ju.europa.eu/ | 38家机构，2025启动；包括通用处理器、矢量加速器、AI处理器                                  |
| Quintauris                         | 高通、博世、英飞凌、恩智浦、北欧半导体合资成立，汽车/IoT                          | https://www.quintauris.com/   | 加速RISC-V在全球汽车与IoT领域商业化；2025推出RT-Europa实时Profile，与Andes/Lauterbach合作 |
| RIOS Lab                           | 国际RISC-V开源实验室，推动生态建设                                                | https://www.rioslab.org/      | 开源IP、大学合作、开源社区                                                                |
...
| CORE-V Family     | OpenHW Group主导的开源、工业级验证的RISC-V IP核家族与验证平台 | https://www.openhwgroup.org/                 | CORE-V系列商用IP，面向商用与工业应用                       |
| SWERV             | Western Digital开源的两款RISC-V核心                           | https://github.com/chipsalliance/Cores-SweRV | SweRV EH2（双核）和 SweRV EL2，面向嵌入式和控制应用        |
...
| 苏黎世联邦理工学院 | 在RISC-V安全架构、形式化验证等方面做出重要贡献         | https://ethz.ch/             |                                               |
